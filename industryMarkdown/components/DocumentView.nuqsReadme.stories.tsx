...
const meta: Meta<typeof DocumentView> = {
  title: 'IndustryMarkdown/DocumentView/NuqsReadme',
  ...
  args: {
    theme: defaultTheme,
    // Relative image paths in the README (logo, gif) resolve against this
...
// Pulled from https://github.com/47ng/nuqs (next branch) README.md
const nuqsReadme = `<div align="center">
  <picture>
...
export const Wide: Story = {
  args: {
    content: nuqsReadme,
    maxWidth: '1400px',
    slideIdPrefix: 'nuqs-readme-wide',
  },
};
...
export const RegalTheme: Story = {
  args: {
    content: nuqsReadme,
    maxWidth: '900px',
    slideIdPrefix: 'nuqs-readme-regal',
    theme: regalTheme,
  },
};
