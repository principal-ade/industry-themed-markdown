...
const meta: Meta<typeof DocumentView> = {
  title: 'IndustryMarkdown/DocumentView/EnvoyReadme',
  ...
  args: {
    theme: defaultTheme,
    // Relative link/image paths (CONTRIBUTING.md, api/, docs/security/...) resolve
    // against this to GitHub URLs; without it they 404.
    repositoryInfo: {
      owner: 'envoyproxy',
      repo: 'envoy',
      branch: 'main',
...
// Pulled from https://github.com/envoyproxy/envoy (main branch) README.md
const envoyReadme = `![Envoy Logo](https://github.com/envoyproxy/artwork/blob/main/PNG/Envoy_Logo_Final_PANTONE.png)
...
export const Wide: Story = {
  args: {
    content: envoyReadme,
    maxWidth: '1400px',
    slideIdPrefix: 'envoy-readme-wide',
  },
};
...
export const RegalTheme: Story = {
  args: {
    content: envoyReadme,
    maxWidth: '900px',
    slideIdPrefix: 'envoy-readme-regal',
    theme: regalTheme,
  },
};
