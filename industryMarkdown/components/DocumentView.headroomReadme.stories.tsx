...
const meta: Meta<typeof DocumentView> = {
  title: 'IndustryMarkdown/DocumentView/HeadroomReadme',
  ...
  args: {
    theme: defaultTheme,
    // Relative image paths (HeadroomDemo-Fast.gif, headroom_learn.gif) resolve
    // against this to GitHub raw URLs; without it they 404.
    repositoryInfo: {
...
// Pulled from https://github.com/headroomlabs-ai/headroom (main branch) README.md
const headroomReadme = `<div align="center"><pre>
  ██╗  ██╗███████╗ █████╗ ██████╗ ██████╗  ██████╗  ██████╗ ███╗   ███╗
  ██║  ██║██╔════╝██╔══██╗██╔══██╗██╔══██╗██╔═══██╗██╔═══██╗████╗ ████║
  ███████║█████╗  ███████║██║  ██║██████╔╝██║   ██║██║   ██║██╔████╔██║
  ██╔══██║██╔══╝  ██╔══██║██║  ██║██╔══██╗██║   ██║██║   ██║██║╚██╔╝██║
...
export const Default: Story = {
  args: {
    content: headroomReadme,
    maxWidth: '900px',
    slideIdPrefix: 'headroom-readme',
...
export const Wide: Story = {
  args: {
    content: headroomReadme,
    maxWidth: '1400px',
    slideIdPrefix: 'headroom-readme-wide',
  },
};
...
export const RegalTheme: Story = {
  args: {
    content: headroomReadme,
    maxWidth: '900px',
    slideIdPrefix: 'headroom-readme-regal',
    theme: regalTheme,
  },
};
