...
const meta: Meta<typeof DocumentView> = {
  title: 'IndustryMarkdown/DocumentView/BacklogMdReadme',
  ...
  args: {
    theme: defaultTheme,
    // Relative image paths in the README (demo GIF, section icons, web screenshot)
    // resolve against this to GitHub raw URLs; without it they 404.
    repositoryInfo: {
      owner: 'MrLesk',
      repo: 'Backlog.md',
      branch: 'main',
...
// Pulled from https://github.com/MrLesk/Backlog.md (main branch) README.md
const backlogReadme = `<h1 align="center">Backlog.md</h1>
...
export const Default: Story = {
  args: {
    content: backlogReadme,
    maxWidth: '900px',
    slideIdPrefix: 'backlog-readme',
...
export const Wide: Story = {
  args: {
    content: backlogReadme,
    maxWidth: '1400px',
    slideIdPrefix: 'backlog-readme-wide',
  },
};
...
export const RegalTheme: Story = {
  args: {
    content: backlogReadme,
    maxWidth: '900px',
    slideIdPrefix: 'backlog-readme-regal',
    theme: regalTheme,
  },
};
